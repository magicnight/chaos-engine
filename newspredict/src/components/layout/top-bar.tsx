  ...
  return (
    <header className="flex items-center justify-between px-4 pt-4 pb-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <Link href="/notifications" className="relative w-9 h-9 rounded-full bg-[var(--card)] border border-[var(--border)] flex items-center justify-center hover:border-[var(--accent)]/30 transition-colors">
